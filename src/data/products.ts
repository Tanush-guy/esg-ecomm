...
const baseProducts: ProductSeed[] = [
  ...
  },
  {
    ...
    category: "Toiletries",
    description: "Innovative 3-sided toothbrush design that cleans all tooth surfaces simultaneously in one stroke. Provides thorough brushing in less time with ultra-soft bristles for gentle gum care. Ideal for kids, elderly, and anyone who wants a quicker, more efficient brushing experience."
  },
  {
    id: 6,
  ...
  },
  {
    ...
    category: "Cleaning",
    description: "Versatile 4-in-1 tile cleaning brush with interchangeable heads for grout lines, flat tiles, corners, and textured surfaces. Long ergonomic handle reduces back strain and makes bathroom, kitchen, and floor cleaning effortless. Durable bristles that will not scratch delicate surfaces."
  },
  {
    id: 9,
  ...
  },
  {
    ...
    category: "Beauty",
    description: "Electric hair straightening comb that detangles and straightens simultaneously in minutes. Ceramic heating plates with 5 adjustable temperature settings for all hair types. Quick 30-second heat-up technology, anti-scald design, and auto shut-off for safety."
  },
  {
    id: 14,
    ...
    category: "Health",
    description: "Electronic muscle stimulation foot massager mat for deep relaxation after long days. Features 6 massage modes and 9 intensity levels to relieve foot fatigue, reduce swelling, and improve blood circulation. Foldable, portable design that can be used anywhere."
  },
  {
    id: 15,
    ...
    category: "Electrical",
    description: "Quick-connect low voltage wire connectors for easy and secure electrical connections. No wire stripping required. Suitable for various wire gauges from 12 to 28 AWG. Transparent housing lets you verify proper connection."
  },
  {
    id: 16,
    ...
    category: "Kitchen",
    description: "Easy-to-use magnetic indicator that shows the remaining gas level in your LPG cylinder at a glance. Simply attach it to the side of the cylinder with the built-in magnet. Temperature-sensitive strip changes color to show exact gas level."
  },
  {
    id: 17,
    name: "Nose Trimmer",
    ...
    description: "Compact and precise nose hair trimmer with dual-edge stainless steel rotary blades for painless trimming. Ergonomic pen-style design for easy handling. Battery-operated for portable grooming on the go."
  },
  {
    id: 18,
    ...
    category: "Kitchen",
    description: "Manual ceramic burr coffee grinder for the freshest ground coffee anywhere you go. Adjustable grind settings from fine espresso to coarse French press with consistent results every time. Portable, durable stainless steel body with a comfortable crank handle."
  },
  {
    id: 19,
    ...
    description: "Double-sided rechargeable hand warmer with 3 heating levels for customizable warmth. Also doubles as a portable 5000mAh power bank to charge your phone on the go. Heats up in seconds and lasts up to 8 hours on a single charge."
  },
  {
    id: 20,
    name: "Mini Shaver",
    ...
    category: "Personal Care",
    description: "Ultra-compact mini electric shaver for quick touch-ups and clean grooming on the go. USB rechargeable with a powerful yet quiet motor for a clean, smooth shave. Pocket-sized convenience with a travel-friendly design."
  },
  {
    id: 21,
    ...
    category: "Bath",
    description: "Hygienic silicone body scrubber that gently exfoliates dead skin cells and massages your body. Easy to clean, quick-drying, and more sanitary than traditional loofahs or washcloths. Soft, flexible bristles are gentle on sensitive skin."
  },
  {
    id: 22,
    ...
    category: "Cleaning",
    description: "Magic eraser sponge specifically designed for cleaning sneakers, leather shoes, and canvas footwear. Effortlessly removes scuff marks, dirt, grass stains, and yellowing without water or harsh chemicals."
  }
];
